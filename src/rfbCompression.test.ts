...
test("RFB compression wrappers round-trip a zlib payload", () => {
...
test("RFB inflator supports sequential reads from one zlib stream", () => {
...
test("RFB inflator reset starts a new zlib stream", () => {
