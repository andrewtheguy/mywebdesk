 ...
 *
 * Websock adds high-performance receive and send queues to a browser
 * WebSocket.
 *
...
export default class Websock {
  ...
  rQwait(_msg: string, num: number, goback?: number): boolean {
  ...
  on<K extends keyof WebsockEventHandlers>(
    evt: K,
    handler: WebsockEventHandlers[K],
  ): void {
  ...
  attach(rawChannel: WebSocket): void {
    this.init();
